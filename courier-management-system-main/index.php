...
<body>
    <h1 align='center' style="margin: 15px; color:seagreen;font-weight: bold;font-family:'Times New Roman', Times, serif">COURIER SERVICE</h1>
    <hr />
    <h2 align='center' style="font-weight: bold;color:orange;font-family:'Times New Roman', Times, serif">The Fastest Courier Service Ever</h2>
    <div>
        <h5><a href="admin/cms/login.php" style="float: right; margin-right:40px; color:blue; margin-top:0px">AdminLogin</a></h5>
    </div>
            ...
            <div class="col-md-12">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="name" name="email" class="form-control" placeholder="Enter Your Email ID" required />
                    </div>
                    <div class="form-group">
